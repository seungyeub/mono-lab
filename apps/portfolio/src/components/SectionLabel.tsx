...
export default function SectionLabel({
  ...
  return (
    ...
    >
      <div className='w-full text-[13px] bg-[#0A0A0A]'>
        <div className='flex flex-col gap-2.5 overflow-hidden'>
          <div className='h-px w-full bg-transparent' />
          <div className='site-container flex items-center justify-between px-6 md:px-12 uppercase text-[#bbbbbb]'>
            <h6 className='flex-1 text-left whitespace-pre text-white'>{leftLabel}</h6>
            <h6 className='flex-1 text-center hidden whitespace-pre text-[#bbbbbb]/60 md:block'>
              SCENE — {scene}
            </h6>
