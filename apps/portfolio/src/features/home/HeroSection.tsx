...
export default function HeroSection() {
  ...
  return (
    <section ref={containerRef} className='relative w-full min-h-[74vw] md:min-h-[720px]'>
      {/* ── 2단 메인 그리드 ── */}
      <div className='site-container px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-0'>
        {/* LEFT — 타이포그래피 */}
        <motion.div
        ...
        >
          ...
          <motion.div
            ...
            className='hidden sm:block md:mt-12 lg:mt-20 pointer-events-auto'
          >
        ...
        <motion.div
          ...
          className='relative w-full h-[120vw] sm:h-[96vw] md:h-auto md:min-h-[500px] rounded-xl bg-transparent col-start-1 row-start-1 md:col-start-2'
        >
      ...
      <div className='mt-24 h-px w-full bg-[#bbbbbb]/20' />
