...
jest.mock('@react-three/drei', () => ({
  Environment: ({ children }: { children?: React.ReactNode }) => <div data-testid='mock-environment'>{children}</div>,
  Lightformer: () => <div data-testid='mock-lightformer' />,
}));

jest.mock('@react-three/rapier', () => ({
  Physics: ({ children }: { children?: React.ReactNode }) => <div data-testid='mock-physics'>{children}</div>,
}));
