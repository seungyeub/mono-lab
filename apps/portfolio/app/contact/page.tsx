    ...
    <main className="min-h-screen w-full px-6 md:px-12 pt-32 pb-24 bg-[#0a0a0a]">
      <div className="flex flex-col md:flex-row justify-between gap-16 border-b border-white/10 pb-16">
        ...
        <div className="flex flex-col gap-8 md:max-w-xs text-gray-400 text-sm md:text-base justify-end">
          ...
          <div>
            <p className="text-white font-medium mb-1 uppercase tracking-widest text-xs">Based in</p>
            <p>Seoul, 한국</p>
          </div>
          <div>
            <p className="text-white font-medium mb-1 uppercase tracking-widest text-xs">Networks</p>
