...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang='en'>
      <body
        className={`${inter.className} text-white min-h-screen antialiased selection:bg-white selection:text-black`}
      >
        <PageLoader />
        <CustomCursor />
        <SmoothScroll>
          <Header />
          <main className='site-container min-h-screen w-full'>{children}</main>
          <Footer />
        </SmoothScroll>
      </body>
    </html>
