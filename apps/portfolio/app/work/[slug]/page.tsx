...
const mdxComponents = {
  ...
  h2: (props: any) => <h2 className="text-xl md:text-2xl font-medium mt-8 mb-3 text-gray-200" {...props} />,
  p:  (props: any) => <p className="text-base md:text-lg text-gray-400 leading-relaxed mb-5" {...props} />,
  ul: (props: any) => <ul className="list-disc list-inside text-base md:text-lg text-gray-400 mb-5 flex flex-col gap-1.5" {...props} />,
        ...
        <div className="flex-1 md:pl-16 flex flex-col gap-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
            {[
              ...
              <div
                key={imgPath}
                className="aspect-[4/3] bg-[#1a1a1a] relative overflow-hidden"
              >
                <div
                  className="absolute inset-0 bg-cover bg-center"
